...
if (!empty($_GET['id'])) {
	...
	$url = "http://jam.geograph.org.uk/sample8ql.php?where=id=$id&select=*&limit=1";
...
licensed for <a href="/reuse.php?id=<? echo $id; ?>">reuse</a> under this <a rel="license" href="http://creativecommons.org/licenses/by-sa/2.0/" class="nowrap" about="<? echo $fullurl; ?>" title="Creative Commons Attribution-Share Alike 2.0 Licence">Creative Commons Licence</a>.</div>


<div  align="center" style="margin:10px;padding:5px;border-bottom:1px solid gray;font-size:0.8em;">
	· <a href="/reuse.php?id=<? echo $id; ?>">Find out <b>How to reuse</b> this image</a> ·
...
<table align="center" cellpadding=5>
	...
	<tr>
		<th>Submitted</th>
		<td><a href=""><? echo date('Y-m-d',$row->submitted); ?></a></td>
	</tr>
